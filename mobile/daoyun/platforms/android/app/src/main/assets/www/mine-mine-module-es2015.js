...
/* harmony import */ var _mine_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mine.page */ "./src/app/pages/mine/mine.page.ts");
...
const routes = [
    ...
    {
        path: 'user-info',
        loadChildren: () => __webpack_require__.e(/*! import() | user-info-user-info-module */ "user-info-user-info-module").then(__webpack_require__.bind(null, /*! ./user-info/user-info.module */ "./src/app/pages/mine/user-info/user-info.module.ts")).then(m => m.UserInfoPageModule)
    },
    {
        path: 'edit-account',
        loadChildren: () => __webpack_require__.e(/*! import() | edit-account-edit-account-module */ "edit-account-edit-account-module").then(__webpack_require__.bind(null, /*! ./edit-account/edit-account.module */ "./src/app/pages/mine/edit-account/edit-account.module.ts")).then(m => m.EditAccountPageModule)
    },
    {
        path: 'about-us',
        loadChildren: () => __webpack_require__.e(/*! import() | about-us-about-us-module */ "about-us-about-us-module").then(__webpack_require__.bind(null, /*! ./about-us/about-us.module */ "./src/app/pages/mine/about-us/about-us.module.ts")).then(m => m.AboutUsPageModule)
    },
    {
        path: 'set-account',
        loadChildren: () => __webpack_require__.e(/*! import() | set-account-set-account-module */ "set-account-set-account-module").then(__webpack_require__.bind(null, /*! ./set-account/set-account.module */ "./src/app/pages/mine/set-account/set-account.module.ts")).then(m => m.SetAccountPageModule)
    },
    {
        path: 'edit-password',
        loadChildren: () => __webpack_require__.e(/*! import() | edit-password-edit-password-module */ "edit-password-edit-password-module").then(__webpack_require__.bind(null, /*! ./edit-password/edit-password.module */ "./src/app/pages/mine/edit-password/edit-password.module.ts")).then(m => m.EditPasswordPageModule)
    },
    {
        path: 'share-friends',
        loadChildren: () => __webpack_require__.e(/*! import() | share-friends-share-friends-module */ "share-friends-share-friends-module").then(__webpack_require__.bind(null, /*! ./share-friends/share-friends.module */ "./src/app/pages/mine/share-friends/share-friends.module.ts")).then(m => m.ShareFriendsPageModule)
    },
    {
        path: 'headfaces',
        loadChildren: () => __webpack_require__.e(/*! import() | headfaces-headfaces-module */ "headfaces-headfaces-module").then(__webpack_require__.bind(null, /*! ./headfaces/headfaces.module */ "./src/app/pages/mine/headfaces/headfaces.module.ts")).then(m => m.HeadfacesPageModule)
    },
];
let MinePageRoutingModule = class MinePageRoutingModule {
};
MinePageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _mine_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mine-routing.module */ "./src/app/pages/mine/mine-routing.module.ts");
/* harmony import */ var _mine_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mine.page */ "./src/app/pages/mine/mine.page.ts");
...
/* harmony import */ var src_app_shared_services_zr_services_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/services/zr-services.service */ "./src/app/shared/services/zr-services.service.ts");
...
let MinePage = class MinePage {
    constructor(modalController, localStorageService, eventService, navCtrl, router, alertController, zrServices) {
...
MinePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-mine',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./mine.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/mine/mine.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./mine.page.scss */ "./src/app/pages/mine/mine.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], src_app_shared_services_mylocalstorage_service__WEBPACK_IMPORTED_MODULE_4__["MylocalstorageService"],
        src_app_shared_services_event_service__WEBPACK_IMPORTED_MODULE_7__["EventService"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"], src_app_shared_services_zr_services_service__WEBPACK_IMPORTED_MODULE_6__["ZrServicesService"]])
], MinePage);
...
//# sourceMappingURL=mine-mine-module-es2015.js.map