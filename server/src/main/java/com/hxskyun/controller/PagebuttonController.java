...
@RequestMapping("/Pagebutton")
public class PagebuttonController {

    @PostMapping
    public ServerResponse insert(@RequestBody Pagebutton record) {
        return new ServerResponse(0, null, "插入成功");
    }

    @PostMapping("/select")
    public ServerResponse insertSelective(@RequestBody Pagebutton record) {
    ...
    @PutMapping("/{uuid}")
    public ServerResponse update(@PathVariable String uuid, @RequestBody Pagebutton record) {
        return new ServerResponse(0, null, "更新成功");
    }

    @PutMapping("/select/{uuid}")
    public ServerResponse updateSelective(@PathVariable String uuid, @RequestBody Pagebutton record) {
